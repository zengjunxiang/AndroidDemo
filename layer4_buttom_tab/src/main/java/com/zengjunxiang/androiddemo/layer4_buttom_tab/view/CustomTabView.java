package com.zengjunxiang.androiddemo.layer4_buttom_tab.view;
...
public class CustomTabView extends LinearLayout implements View.OnClickListener{
    ...
    public void addTab(Tab tab){
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_custom_tab_item_layout,null);
